...
int rollno;
char name[50];
int eng_marks, math_marks, sci_marks, lang2_marks, cs_marks, sch_part;
double average;
char grade;
...
{
average=(eng_marks+math_marks+sci_marks+lang2_marks+cs_marks+sch_part)/5.0;
if(average>=90)
grade='A';
else if(average>=75)
grade='B';
...
cin>>cs_marks;
cout<<"\nEnter Students participation score: ";
cin>>sch_part;
calculate();
}
